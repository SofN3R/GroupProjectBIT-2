let character2 = fetch('https://swapi.dev/api/people/10/')
    ...
    .then(data => {
        ...
        let heightCharacter = document.getElementById("height");
        heightCharacter.append("Height: " + data.height);
        // document.body.append(heightCharacter);

        let massCharacter = document.getElementById("mass");
        massCharacter.append("Mass: " + data.mass);
        // document.body.append(massCharacter);

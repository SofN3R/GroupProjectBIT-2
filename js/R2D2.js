let character2d2 = fetch('https://swapi.dev/api/people/3/')
    .then(response => response.json())
    .then(data => {

        // Buscar el elemento HTML con el id name
        let nameCharacter = document.getElementById("name5");
